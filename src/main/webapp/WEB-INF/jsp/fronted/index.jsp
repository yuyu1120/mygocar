    ...
    <body>
      ...
      <script>
        ...
        document.getElementById("textbtn").addEventListener("click", async () => {
          ...
          const result = await res.json(); // 後端回傳 { exists: true/false }

          if (result.exists) {

            document.getElementById("account").value = "b123";
            document.getElementById("password").value = "c123";
